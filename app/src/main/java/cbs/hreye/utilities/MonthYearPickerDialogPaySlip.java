...
import cbs.hreye.activities.PaySlipActivity;
import cbs.hreye.R;

public class MonthYearPickerDialogPaySlip extends DialogFragment {
        ...
        builder.setView(dialog)
                .setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                         ((PaySlipActivity) getActivity()).getResult(monthPicker.getValue(),yearPicker.getValue());
                    }
                })
                .setNegativeButton("CANCEL", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        MonthYearPickerDialogPaySlip.this.getDialog().cancel();
                    }
                });
